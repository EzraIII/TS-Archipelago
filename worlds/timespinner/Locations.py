...
def get_location_datas(world: Optional[MultiWorld], player: Optional[int], 
    ...
    location_table: List[LocationData] = [
        ...
        LocationData('Lake desolation', 'Lake Desolation: Forget me not chest',  1337006, lambda state: logic.has_fire(state) and state.can_reach('Upper Lake Serene', 'Region', player) or is_option_enabled(world, player, "GlitchesLogic") and logic.has_upwarddash(state)), # TODO: GlitchesLogic & Hairpin & Talaria
        LocationData('Lake desolation', 'Lake Desolation (Lower): Chicken chest', 1337007, logic.has_timestop or is_option_enabled(world, player, "GlitchesLogic")),
        LocationData('Lower lake desolation', 'Lake Desolation (Lower): Not so secret room',  1337008, logic.can_break_walls or is_option_enabled(world, player, "GlitchesLogic")),
        ...
        LocationData('Upper lake desolation', 'Lake Desolation (Upper): Secret room',  1337011, logic.can_break_walls or is_option_enabled(world, player, "GlitchesLogic")),
        LocationData('Upper lake desolation', 'Lake Desolation (Upper): Double jump cave platform',  1337012, logic.has_doublejump), # TODO: EnemyRando with GlitchesLogic support
        ...
        LocationData('The lab', 'Lab: Lower trash right',  1337067, flooded.flood_lab or logic.has_doublejump), # TODO: EnemyRando Support
        ...
        LocationData('The lab', 'Lab: Trash jump room',  1337070, logic.has_upwarddash),
        LocationData('The lab (power off)', 'Lab: Dynamo Works',  1337071),
        LocationData('The lab (upper)', 'Lab: Genza (Blob Mom)',  1337072),
        LocationData('The lab', 'Lab: Experiment #13',  1337073, lambda state: state.can_reach('The lab (power off)', 'Region', player) or is_option_enabled(world, player, "TwoPlayerLogic") and (logic.has_doublejump(state) or logic.has_fastjump_on_npc(state)) or is_option_enabled(world, player, "GlitchesLogic") and logic.has_doublejump(state)),
        ...
        LocationData('The lab', 'Lab: Spider Hell',  1337076, lambda state: state.can_reach('The lab (power off)', 'Region', player) and logic.has_keycard_A(state) or is_option_enabled(world, player, "GlitchesLogic") and (flooded.flood_lab or logic.has_doublejump(state))),
        ...
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): Deep dive',  1337105, lambda state: not flooded.flood_lake_serene or state.has('Water Mask', player)),
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): Under the eels',  1337106, lambda state: not flooded.flood_lake_serene or state.has('Water Mask', player)),
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): Water spikes room',  1337107, lambda state: not flooded.flood_lake_serene or state.has('Water Mask', player)),
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): Underwater secret',  1337108, lambda state: (not flooded.flood_lake_serene or state.has('Water Mask', player)) and logic.can_break_walls),
        ...
        LocationData('Lower Lake Serene', 'Lake Serene (Lower): Past the eels',  1337110, lambda state: not flooded.flood_lake_serene or state.has('Water Mask', player)),
        ...
        LocationData('Caves of Banishment (Sirens)', 'Caves of Banishment (Maw): Mineshaft',  1337122, lambda state: state.can_reach('Caves of Banishment (Maw)', 'Region', player) and state.has_any({'Gas Mask', 'Talaria Attachment'}, player) and (not flooded.flood_maw or state.has('Water Mask', player)) or is_option_enabled(world, player, "GlitchesLogic") and state.has('Lightwall', player)),
